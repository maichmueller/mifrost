/**
 * @file goal_inputs.hpp
 * @brief Pymimir goal container and goal-layer concepts.
 *
 * This file groups goals by tag and stores optional goal levels before any
 * encoder-specific naming or tuple building starts.
 */
#pragma once
 ...
 *
 * Invariant:
 *  - goal lists and level maps are updated together, so any literal present in
 *    a list has a corresponding entry in the matching level map.
 */
struct GoalInputs {
   /// Static goals.
