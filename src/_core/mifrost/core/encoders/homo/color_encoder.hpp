/**
 * @file color_encoder.hpp
 * @brief Homogeneous graph encoder based on color-style atom/object nodes.
 *
 * This encoder is separate from the flat and hetero encoders. It produces one
 * homogeneous graph instead of typed edge groups or tuple tensors.
 */
#pragma once
...
/**
 * @brief Color encoder that produces homogeneous graphs.
 *
 * Responsibility:
