/**
 * @file hgraph_stream_encoder.hpp
 * @brief Heterogeneous graph encoder for state, goal, action, and history inputs.
 *
 * This is the shared base class for hetero encoders. Horizon and successor
 * encoders build on top of it instead of reimplementing object, fact, and
 * target handling.
 */
#pragma once
...
/**
 * @brief Input data for one streaming encode step.
 *
