/**
 * @file target_metadata.cpp
 * @brief Shared target-metadata row and column helpers.
 *
 * Flat and hetero encoders both use this file when exporting target metadata.
 * The column vectors must stay aligned because builders collate them separately.
 */
