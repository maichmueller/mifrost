"""Pymimir-specific input types and legacy custom-adapter registry."""
...
def register_state_adapter(state_type: type[object], adapter: StateAdapter) -> None:
    """Register an exact-type adapter returning a Pymimir advanced state."""
...
def register_domain_adapter(domain_type: type[object], adapter: DomainAdapter) -> None:
    """Register an exact-type adapter returning a Pymimir advanced domain."""
...
def register_literal_adapter(
    ...
    """Register an exact-type adapter returning a Pymimir advanced literal."""
...
def register_action_adapter(action_type: type[object], adapter: ActionAdapter) -> None:
    """Register an exact-type adapter returning a Pymimir advanced action."""
