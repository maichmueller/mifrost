...
from ._core import BatchBuilder, GoalInputs, HGraphEncoderEngine
...
def _parts_to_pyg(
    ...
    *,
    ...
    for node_type, names in node_names.items():
        data[node_type].node_names = list(names)
    if object_names:
...
class HGraphEncoder:
    def __init__(
        ...
        *,
        ...
        self._engine = HGraphEncoderEngine(
            _advanced_domain(domain),
